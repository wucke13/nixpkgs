...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    ...
    # TODO remove once https://github.com/LinuxCNC/linuxcnc/pull/4021 lands in a release
    ./fix-image-to-gcode.patch

    # TODO remove on the next release after 2.9.8A
    # This patch fixes the PREEMPT_RT detection logic for more recent kernels (6.12 and later).
